...
pub unsafe trait Class: 'static {
    /// The layout of the class's fields, excluding vtable and base class data.
    type Data;

    /// The full class layout, FFI-compatible with the equivalent C++ object.
    ///
    /// `V` is the main (first) vtable.
    type Layout<V: 'static>: 'static + AsRef<Self::Data> + AsMut<Self::Data>;
...
/// **This trait should not be implemented manually**. Invariants that
/// guarantee soundness are not stable and may change subtly between versions.
pub unsafe trait BaseVtableFor<C: Class + ?Sized> {
    const VTABLE: C::Vmt;
...
#[inline(always)]
pub fn base_offset<B: Class + ?Sized, C: SubclassOf<B> + ?Sized>() -> usize {
...
/// implement [`Sized`].
///
/// [`Cls`] can [`DerefMut`] into the [`Class::Data`] type. It also implements [`AsRef`] and
...
#[repr(C)]
pub struct Cls<C: Class + ?Sized>(C::Layout<&'static C::Vmt>);

impl<C: Class + ?Sized> Cls<C> {
    /// Upcast to a base type. The equivalent of `static_cast<B& const>(self)` in C++.
    #[inline(always)]
    pub fn upcast<B: Class + ?Sized>(&self) -> &DynCls<B>
    where
        Self: SubclassOf<B>,
    {
        unsafe {
    ...
    #[inline(always)]
    pub fn upcast_mut<B: Class + ?Sized>(&mut self) -> &mut DynCls<B>
    where
        Self: SubclassOf<B>,
    {
        unsafe {
...
impl<C: Class + ?Sized> Deref for Cls<C> {
    type Target = C::Data;
...
impl<C: Class + ?Sized> DerefMut for Cls<C> {
    #[inline(always)]
...
impl<B: Class + ?Sized, C: SubclassOf<B> + ?Sized> AsRef<DynCls<B>> for Cls<C> {
    #[inline(always)]
...
impl<B: Class + ?Sized, C: SubclassOf<B> + ?Sized> AsMut<DynCls<B>> for Cls<C> {
    #[inline(always)]
...
impl<B: Class + ?Sized, C: SubclassOf<B> + ?Sized> AsRef<Cls<B>> for Cls<C> {
    #[inline(always)]
...
///
/// [`DynCls`] can [`DerefMut`] into the [`Class::Data`] type. It also implements [`AsRef`] and
/// [`AsMut`] for all base classes of `C`, so these methods may be used to access base data.
/// Virtual methods of base classes can be called without needing to do this.
#[repr(C)]
pub struct DynCls<C: Class + ?Sized>(C::Layout<&'static C::Vmt>, [()]);

impl<C: Class + ?Sized> FromThinPtr for DynCls<C> {
    #[inline(always)]
...
impl<C: Class + ?Sized> DynCls<C> {
    ...
    #[inline(always)]
    pub unsafe fn downcast<D: SubclassOf<C> + ?Sized>(&self) -> &DynCls<D> {
    ...
    /// Must be a valid instance of `D`.
    #[inline(always)]
    pub unsafe fn downcast_mut<D: SubclassOf<C> + ?Sized>(&mut self) -> &mut DynCls<D> {
...
impl<C: Class + ?Sized> Deref for DynCls<C> {
    type Target = C::Data;
...
impl<C: Class + ?Sized> DerefMut for DynCls<C> {
    #[inline(always)]
    fn deref_mut(&mut self) -> &mut Self::Target {
        self.0.as_mut()
    }
...
impl<B: Class + ?Sized, C: SubclassOf<B> + ?Sized> AsRef<DynCls<B>> for DynCls<C> {
    #[inline(always)]
    fn as_ref(&self) -> &DynCls<B> {
        unsafe {
            let base_thin_ptr = (self as *const _ as *const u8).add(base_offset::<B, C>());
...
impl<B: Class + ?Sized, C: SubclassOf<B> + ?Sized> AsMut<DynCls<B>> for DynCls<C> {
    #[inline(always)]
    fn as_mut(&mut self) -> &mut DynCls<B> {
        unsafe {
            let base_thin_ptr = (self as *mut _ as *mut u8).add(base_offset::<B, C>());
...
impl<B: Class + ?Sized, C: SubclassOf<B> + ?Sized> AsRef<Cls<B>> for DynCls<C> {
    #[inline(always)]
    fn as_ref(&self) -> &Cls<B> {
...
pub struct CRef<'a, C: Class + ?Sized, A: Mutability = Ref>(
    NonNull<Cls<C>>,
    PhantomData<A::Variance<'a>>,
);
pub type CRefMut<'a, C> = CRef<'a, C, Mut>;

// immutable references can be copied
impl<'a, C: Class + ?Sized> Clone for CRef<'a, C> {
    #[inline(always)]
    fn clone(&self) -> Self {
        Self(self.0, PhantomData)
    }
}
impl<'a, C: Class + ?Sized> Copy for CRef<'a, C> {}

// CRef `Deref` into a DynCls
impl<'a, C: Class + ?Sized, A: Mutability> Deref for CRef<'a, C, A> {
...
impl<'a, C: Class + ?Sized> DerefMut for CRefMut<'a, C> {
    fn deref_mut(&mut self) -> &mut Self::Target {
...
impl<'a, C: Class + ?Sized, D: SubclassOf<C> + ?Sized> From<&'a Cls<D>> for CRef<'a, C> {
    #[inline(always)]
...
impl<'a, C: Class + ?Sized, D: SubclassOf<C> + ?Sized> From<&'a DynCls<D>> for CRef<'a, C> {
    #[inline(always)]
...
impl<'a, C: Class + ?Sized, D: SubclassOf<C> + ?Sized, A: Mutability> From<&'a mut Cls<D>>
    for CRef<'a, C, A>
{
    #[inline(always)]
...
impl<'a, C: Class + ?Sized, D: SubclassOf<C> + ?Sized, A: Mutability> From<&'a mut DynCls<D>>
    for CRef<'a, C, A>
{
    #[inline(always)]
...
impl<'a, C: Class + ?Sized, D: SubclassOf<C> + ?Sized, A: Mutability> From<CRef<'a, D, A>>
    for &'a Cls<C>
{
    #[inline(always)]
...
impl<'a, C: Class + ?Sized, D: SubclassOf<C> + ?Sized> From<CRefMut<'a, D>> for &'a mut DynCls<C> {
    #[inline(always)]
...
impl<'a, C: Class + ?Sized> From<CRefMut<'a, C>> for CRef<'a, C> {
    #[inline(always)]
...
impl<'a, C: Class + ?Sized> CRefMut<'_, C> {
...
impl<'a, C: Class + ?Sized, D: SubclassOf<C> + ?Sized> From<&'a DynCls<D>> for *const Cls<C> {
    #[inline(always)]
    fn from(value: &'a DynCls<D>) -> Self {
        value.as_ref() as *const _
    }
}
impl<'a, C: Class + ?Sized, D: SubclassOf<C> + ?Sized> From<&'a mut DynCls<D>> for *mut Cls<C> {
    #[inline(always)]
    fn from(value: &'a mut DynCls<D>) -> Self {
...
#[repr(transparent)]
pub struct CBox<C: Class + ?Sized, M: Mutability = Mut>(
    NonNull<Cls<C>>,
    PhantomData<M::Variance<'static>>,
);

/// Variant of [`CBox`] that only provides an immutable view of its data.
pub type CBoxConst<C> = CBox<C, Ref>;

impl<C: Class + ?Sized> CBox<C> {
...
impl<C: Class + ?Sized, M: Mutability> Deref for CBox<C, M> {
    type Target = DynCls<C>;
...
impl<C: Class + ?Sized> DerefMut for CBox<C> {
    #[inline(always)]
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { self.0.as_mut() }.as_dyn_mut()
    }
...
impl<B: Class + ?Sized, C: SubclassOf<B> + ?Sized, M: Mutability> AsRef<DynCls<B>> for CBox<C, M> {
    #[inline(always)]
    fn as_ref(&self) -> &DynCls<B> {
        self.deref().as_ref()
    }
}
impl<B: Class + ?Sized, C: SubclassOf<B> + ?Sized, M: Mutability> AsRef<Cls<B>> for CBox<C, M> {
    #[inline(always)]
    fn as_ref(&self) -> &Cls<B> {
        self.deref().as_ref()
    }
}
impl<B: Class + ?Sized, C: SubclassOf<B> + ?Sized> AsMut<DynCls<B>> for CBox<C> {
    #[inline(always)]
    fn as_mut(&mut self) -> &mut DynCls<B> {
...
/// layout as [`DynCls<C>`].
///
/// [`Impl`] can [`DerefMut`] into the [`Class::Data`] type. However, unlike [`DynCls`] and [`Cls`],
/// it does not implement any virtual function trait. One must explicitly upcast to a [`Impl<Base>`]
/// to execute its logic!
#[repr(C)]
pub struct Impl<C: Class + ?Sized>(DynCls<C>);

impl<C: Class + ?Sized> FromThinPtr for Impl<C> {
    #[inline(always)]
    unsafe fn from_thin_ptr(ptr: *const u8) -> *const Self {
        core::slice::from_raw_parts(ptr, 0) as *const [u8] as *const Self
    }
...
impl<C: Class + ?Sized> Impl<C> {
    /// Upcast to a base type. The equivalent of `static_cast<B& const>(self)` in C++.
    #[inline(always)]
    pub fn upcast<B: Class + ?Sized>(&self) -> &Impl<B>
    where
        Self: SubclassOf<B>,
    {
        unsafe {
    ...
    /// Upcast to a base type. The equivalent of `static_cast<B&>(self)` in C++.
    #[inline(always)]
    pub fn upcast_mut<B: Class + ?Sized>(&mut self) -> &mut Impl<B>
    where
        Self: SubclassOf<B>,
    {
        unsafe {
